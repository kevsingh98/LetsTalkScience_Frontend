...
import { createAndUpdateProfile, getProfile } from "../services/ProfileService";
    ...
    <div>
      ...
      <section className="template__body">
        <nav className="sideNavigation">
          ...
          <a className="sideNavigation__item" href="./news">
            <i className="icon material-icons">trending_up</i>
            <span> Trending News </span>
          </a>
          <a className="sideNavigation__item" href="./explore">
